...
class CreatePostsViewController: UIViewController {
    ...
    @IBOutlet weak var createPostsNavigationBar: UINavigationBar!
    
    override func viewDidLoad() {
        super.viewDidLoad()
        createPostsNavigationBar.shadowImage = UIImage()
    ...
    @IBAction func edgePanGesture(sender: UIScreenEdgePanGestureRecognizer) {
        ...
        MenuHelper.mapGestureStateToInteractor(
            ...
            interactor: interactor){
                self.performSegue(withIdentifier: "CPshowSlidingMenu", sender: nil)
        }
    }
    func languageChange(str: String){
        self.bar.title = "Create Posts".localizableString(loc: str)
    }
}
extension CreatePostsViewController: UIViewControllerTransitioningDelegate {
